...
export const translations = {
  en: {
    ...
    returns: {
      title: "Return Policy",
      note: "Because each order is specially packed for every customer, once an order is placed, returns and exchanges are not accepted.",
      standardTitle: "Before Shipment",
      standardDesc: "Before your order is shipped, you may switch to other items by contacting us via email or WhatsApp.",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "How do I pay?", a: "You can pay via Direct Bank Transfer or contact us via WhatsApp to pay with Apple Pay." },
  ...
  zh: {
    ...
    returns: {
      title: "退换货政策",
      note: "由于产品都是为每个人特意打包的，一旦下单，不退不换。",
      standardTitle: "标准退货",
      standardDesc: "在未发货之前，可以协商更换为其他商品。请通过邮件或 WhatsApp 联系我们进行沟通。",
      damagedTitle: "破损商品",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "如何付款？", a: "您可以直接进行银行转账，或通过 WhatsApp 联系我们使用 Apple Pay。" },
  ...
  es: {
    ...
    returns: {
      ...
      note: "Dado que los productos se empaquetan especialmente para cada cliente, una vez realizado el pedido no se aceptan devoluciones ni cambios.",
      standardTitle: "Antes del Envío",
      standardDesc: "Antes del envío, puede acordar cambiar a otros artículos contactándonos por correo electrónico o WhatsApp.",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "¿Cómo pago?", a: "Puedes pagar mediante Transferencia Bancaria Directa o contactarnos por WhatsApp para pagar con Apple Pay." },
